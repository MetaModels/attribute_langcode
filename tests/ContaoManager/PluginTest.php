...
namespace MetaModels\AttributeLangCodeBundle\Test\ContaoManager;

use Contao\ManagerPlugin\Bundle\BundlePluginInterface;
use Contao\ManagerPlugin\Bundle\Config\BundleConfig;
use Contao\ManagerPlugin\Bundle\Parser\ParserInterface;
use MetaModels\AttributeLangCodeBundle\ContaoManager\Plugin;
 ...
 *
 * @covers \MetaModels\AttributeLangCodeBundle\ContaoManager\Plugin
 */
class PluginTest extends TestCase
{
    ...
    public function testBundleConfig()
    {
        ...
        self::assertEquals($bundleConfig->getLoadAfter(), [MetaModelsCoreBundle::class]);
        self::assertEquals($bundleConfig->getReplace(), ['metamodelsattribute_langcode']);
    }
}
